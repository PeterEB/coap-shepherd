...
var Q = require('q'),
    ...
    logRsp = require('debug')('coap-shepherd:response');
...
CoapShepherd.prototype._findByClientId = function (id) {
    if (!_.isString(id) && (!_.isNumber(id) || _.isNaN(id)))
        throw new TypeError('id should be a string or a number');
...
CoapShepherd.prototype._newClientId = function (id) {
    if (!_.isNil(id) && (!_.isNumber(id) || _.isNaN(id)))
