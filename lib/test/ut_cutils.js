...
describe('Signature Check', function () {
    ...
    it('uriParser', function () {
        (function () { cutils.uriParser('x'); }).should.not.throw();
        (function () { cutils.uriParser(5); }).should.throw();
        (function () { cutils.uriParser({}); }).should.throw();
        (function () { cutils.uriParser([]); }).should.throw();
        (function () { cutils.uriParser(); }).should.throw();
    });
...
describe('Functional Check', function () {
    ...
    it('uriParser', function () {
        should(cutils.uriParser('/x/y/z')).be.eql(['x', 'y', 'z']);
        should(cutils.uriParser('/x/y/z/')).be.eql(['x', 'y', 'z']);
        should(cutils.uriParser('x/y/z/')).be.eql(['x', 'y', 'z']);
        should(cutils.uriParser('x/y/z')).be.eql(['x', 'y', 'z']);
    });
