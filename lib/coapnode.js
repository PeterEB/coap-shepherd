...
// [TODO] clientName locationPath check
    ...
    this.port = devAttrs.port || shepherd.clientDefaultPort;
    this._defaultPort = shepherd._clientDefaultPort;
...
CoapNode.prototype.writeAttrs = function (path, attrs, callback) {
    var deferred = Q.defer(),
        self = this,
        chkErr,
        reqObj;
