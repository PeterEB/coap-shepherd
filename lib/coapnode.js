...
CoapNode.prototype._updateResource  = function (oid, iid, rid, data, callback) {
    ...
    if (_.isNull(diff)) {
        ...
        coapdb.modify(this.clientId, path, diff).done(function (delta) {
...
CoapNode.prototype._updateSo = function (path, data, callback) {
    ...
    switch (dateType) {
        case 'object': 
            ...
            break;
        case 'instance': 
            this._updateObjectInstance(dateObj.oid, dateObj.iid, data).done(function () {
                deferred.resolve();
            });
            break;
        case 'resource': 
            this._updateResource(dateObj.oid, dateObj.iid, dateObj.rid, data).done(function () {
                deferred.resolve();
            });
            break;
        default:
